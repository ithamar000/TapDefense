...
public class GreenMonster extends Enemy {
    ...
    public GreenMonster(Resources res,boolean firstTime) {
        super(res);
        startHealth = 1;
        isDie = startHealth;
        hit=false;
    ...
    void initAnimation(Resources res){
        e1_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_000);
        e2_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_002);
        e3_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_004);
        e4_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_006);
        e5_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_008);
        e6_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_010);
        e7_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_012);
        e8_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_014);
        e9_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_016);
        e10_run = BitmapFactory.decodeResource(res, R.drawable.enemies_1_run_018);

        e1_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_000);
        e2_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_002);
        e3_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_004);
        e4_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_006);
        e5_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_008);
        e6_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_010);
        e7_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_012);
        e8_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_014);
        e9_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_016);
        e10_hit = BitmapFactory.decodeResource(res, R.drawable.enemies_1_attack_018);

        e1_die= BitmapFactory.decodeResource(res,R.drawable.enemies_1_die_000);
        e2_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_002);
        e3_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_004);
        e4_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_006);
        e5_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_008);
        e6_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_010);
        e7_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_012);
        e8_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_014);
        e9_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_016);
        e10_die = BitmapFactory.decodeResource(res, R.drawable.enemies_1_die_018);
